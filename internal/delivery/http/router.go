...
func NewRouter(r *gin.Engine, log *slog.Logger, conn *pgx.Conn) {
	...
	v1.NewScheduleRouteGetByTeacher(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByTeacherUUID(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByGroup(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByGroupUUID(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByRoom(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByRoomUUID(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetBySubject(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetBySubjectUUID(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByLocation(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteGetByLocationUUID(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteUpdate(apiV1Group, scheduleUseCase, log)
	v1.NewScheduleRouteDelete(apiV1Group, scheduleUseCase, log)
}
